...
<template>
  ...
  const isLoadign ref 9fatu
  fcuntion loaded {
    isLoading.valeue = false
  } -->
  <!-- <loader v-if="isLoading" /> -->
  <div class="wrapper">
    <OpenImg />
    <div class="container">
      <div class="title has-text-center">
        <p class="pt-5 pb-2 has-text-black">
          ...
          <span style="color: rgb(53, 177, 140); white-space: nowrap"
            >East Godavari</span
          >
        </p>
      </div>
      <div class="content is-size-5">
        <!-- <div
          class="
            errorMessage
            has-text-centered has-text-white has-background-danger
          "
          v-show="errorMessage"
        >
          {{ errorMessage }}
